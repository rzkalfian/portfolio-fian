    ...
    <div className="relative mx-auto">
      ...
      <div className="flex flex-col items-center gap-6 text-center md:hidden">
        <img
          src={profile}
          alt="Fian"
          className="h-56 object-contain grayscale"
        />
        <div className="w-full">
          ...
          <p className="mt-3 font-['Nunito_Sans'] text-[14px] font-light leading-[26px] text-white/70">
          ...
          <div className="mt-6">
            <button className="rounded-full bg-gradient-to-r from-[#014AEB] to-[#1CC8B7] px-6 py-3 font-poppins text-[13px] font-normal text-white">
